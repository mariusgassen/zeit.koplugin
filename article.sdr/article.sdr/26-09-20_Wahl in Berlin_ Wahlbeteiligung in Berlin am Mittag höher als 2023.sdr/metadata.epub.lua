-- /mnt/us/koreader/zeitplus/26-09-20_Wahl in Berlin_ Wahlbeteiligung in Berlin am Mittag höher als 2023.sdr/metadata.epub.lua
return {
    ["annotations"] = {},
    ...
    ["css"] = "./data/epub.css",
    ["doc_pages"] = 40,
    ["doc_path"] = "/mnt/us/koreader/zeitplus/26-09-20_Wahl in Berlin_ Wahlbeteiligung in Berlin am Mittag höher als 2023.epub",
    ["doc_props"] = {
        ["title"] = "Wahl in Berlin: Wahlbeteiligung in Berlin am Mittag höher als 2023",
    },
    ...
    ["last_xpointer"] = "/body/DocFragment/body/div[2]/div/dialog/ul/li[5]/a/svg.0",
    ["page_overlap_style"] = "dim",
    ["partial_md5_checksum"] = "3cf112335697c5e07149c3b1a5b1a5f0",
